local M = {
  ...
  keys = {
      { "grn", function() require('live-rename').rename({ insert = true, text = "" }) end, desc = "LSP Rename" }
  },
  config = function ()
    ...
    -- vim.keymap.set("n", "grn", function () live_rename.rename({ insert = true, text = "" }) end, { desc = "LSP Rename"})
  end
}

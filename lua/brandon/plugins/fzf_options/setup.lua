...
local setup = {
  ...
  files = {
    ...
    path_shorten   = 6,              -- 'true' or number, shorten path?
    -- cmd            = "rg --files",
    ...
    -- cwd_header = true,
    cwd_prompt             = true,
    cwd_prompt_shorten_len = 30,        -- shorten prompt beyond this length
...
-- hls = {
--   normal         = 'Normal',         -- Main window background
--   border         = 'FloatBorder',    -- Window border color
--   help_normal    = 'NormalFloat',
--   help_border    = 'FloatBorder',
--   -- This makes the "match" text pop
--   preview_normal = 'NormalFloat',
--   preview_border = 'FloatBorder',
--   cursor         = 'Cursor',
--   cursorline     = 'Visual',         -- The highlighted selection line
...
--   preview = {
--     layout     = "horizontal",
--     horizontal = "right:50%", -- Perfect 50/50 split
--     -- border     = "none",      -- Removes the middle line for a "Monolith" look
--     border = {"─", "─", "┐", "│","┘","─", "─", "│"},
--     hidden     = "nohidden",
--     title      = true,
--     delay      = 10,          -- Snappy rendering for your 5700X
--   },
-- },
  winopts = {
    -- split = "belowright vnew", -- Opens as a split at the bottom instead of a float
  border     = {"┌", "─", "─", " ","─","─", "└", "│"  },  -- "└",  "┐",  "┘",  "┌",  "│",  "│", "│" ,  "─",
  preview = {
    layout = "horizontal",
    horizontal = "right:60%",
...
actions = {
  -- This is the "hidden" default that fzf-lua uses. 
  -- Without this, the Enter key has no instructions.
  ["default"] = fzf.actions.file_edit_or_qf,

  files = {
    -- Inherit the global default for Enter
    ["default"] = fzf.actions.file_edit_or_qf,
  ...
  grep = {
    -- Inherit the global default for Enter
    ["default"] = fzf.actions.file_edit_or_qf,
    -- Use 'all_to_qf' to ensure your 400+ results all move at once
    ["ctrl-q"]   = fzf.actions.file_all_to_qf,
  },
},
fzf_opts = {
  -- This is the "secret sauce" for the image you provided:
  -- ["--layout"] = "reverse-list", -- Puts input at the bottom, list goes up
  ["--info"]   = "inline-right", -- Puts the '1/468' count on the right
  -- ["--border"] = "bottom",          
  -- This styles the internal border to be a simple horizontal line
},
}
